...
n       = 16;
max     = 5;                        /* max factors */
mod     = 0;                        /* 0 = no shift, 1 = level shift, 2 = regime shift */
...
/* trimming */
load y[54, 16]= TCO2.txt;
load LNEX[54, 16]= EXPUS.txt;
load LNIM[54, 16] = IMPUS.txt;
load GDP[54, 16] = GDPUS.txt;
load HC[54, 16] = HC.txt;
load IVA[54, 16] = IVA.txt;
x = LNEX~LNIM~GDP~HC~IVA;
...
call (TCO2, LNEX~LNIM~GDP~HC~IVA);*/
